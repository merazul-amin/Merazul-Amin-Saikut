...
export const Footer = () => {
  return (
    <div className="text-white" style={{backgroundColor:'rgb(25, 118, 210 )'}}>
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
                    className="text-white-500 transition-colors duration-300 hover:text-deep-purple-accent-200"
                  >
                    News
                  </a>
                </li>
